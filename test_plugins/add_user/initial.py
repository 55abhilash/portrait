...
a = api()
a.add_to_task_list('adduser', 'adduser_input')

a.bind_url('adduser', 'adduser.views.adduser_input', 'adduser_input')
a.bind_url('adduser', 'adduser.views.add_user', 'add_user')
